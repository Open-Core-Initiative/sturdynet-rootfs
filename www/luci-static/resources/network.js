...
type='Broadcom';return'%s 802.11%s Wireless Controller (%s)'.format(type||'Generic',this.getHWModes().sort(L.naturalCompare).join(''),this.getName());},getScanList:function(){return callIwinfoScan(this.sid);},isUp:function(){if(L.isObject(_state.radios[this.sid]))
